<template>
<div>
    <div class="toastList" v-if="orgType=='2010'||orgType=='2011'||orgType=='2012'||orgType=='2017'">
        <div class="toastListTittle">机构详情 <img @click="closecommunityDetail()" src="../../../../assets/images/close_dialog.png" alt=""></div> 
    ...
    <div class="toastList" v-else>
        ...
        <div class="toastcontent">
            ...
            <h3>运营信息</h3>
            <div class="flexd" style="border:none">
                <div>
                    <div>
                        <span>法人性质：</span>
                        <span>{{mes.legalType}}</span>
...
export default {
    props:['closecommunityDetail','id','orgType'],
    data(){
        return{
            mes:''
        }
