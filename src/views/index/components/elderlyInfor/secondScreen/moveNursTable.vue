...
import {getPersonInfoList,getPersonInfoDetail,getServiceInfo,safeguardMsg,creditCardStatistics,creditCardRecords,getOrgtype} from "@/api/elderlyInforDetails"
