...
import {getByCondition,getPersonInfoDetail,getServiceInfo,safeguardMsg,creditCardStatistics,creditCardRecords} from "@/api/elderlyInforDetails"
...
export default {
    ...
    methods:{
        ...
        serviceInfo(){
            getByCondition(this.ruleForm).then(res=>{
                if(res.code==0){
