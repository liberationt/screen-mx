    ...
    <div class="displayFlex">
        <div class="toast">
            <div class="elderInforTitle displayFlex">
                <div class="inforTitleImg" style="cursor: inherit">居家养老信息列表</div>
                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <!-- <template slot-scope="scope">
                            <span class="cursorPointer orangeColor" @click="showDetails(scope.row.id,scope.row.idCard,scope.row.censusArea)">{{scope.row.name}}</span>
                        </template> -->
                    </el-table-column>
                    <el-table-column
                        prop="sex"
...
import {getPersonInfoList,getPersonInfoDetail,getServiceInfo,safeguardMsg,creditCardStatistics,creditCardRecords,getHomeList} from "@/api/elderlyInforDetails"
